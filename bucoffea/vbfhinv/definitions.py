...
def vbfhinv_accumulator(cfg):
    ...
    lead_jet_eta_ax_coarse = Bin("jeteta0", r"Leading jet $\eta$", 20, -5, 5)
    trail_jet_eta_ax_coarse = Bin("jeteta1", r"Trailing jet $\eta$", 20, -5, 5)
    ...
    items["met_mjj"] = Hist("Counts", dataset_ax, region_ax, met_ax, mjj_ax)
    items["dphijj_mjj"] = Hist("Counts", dataset_ax, region_ax, dphi_ax, mjj_ax)
