...
def plot(args):
        ...
        for year in [2017,2018]:
            ...
            data = {
                'sr_vbf' : f'MET_{year}',
                'sr_vbf_noJetsInHF' : f'MET_{year}',
                'sr_vbf_noJetsInHF_noCleaningCuts' : f'MET_{year}',
                'sr_vbf_noHFHFveto' : f'MET_{year}',
                'sr_vbf_noCleaningCuts' : f'MET_{year}',
            ...
            mc_lo = {
                ...
                'sr_vbf_noJetsInHF' : re.compile(f'(ZJetsToNuNu.*|EW.*|Top_FXFX.*|Diboson.*|.*DYJetsToLL_M-50_HT_MLM.*|.*WJetsToLNu.*HT.*).*{year}'),
                'sr_vbf_noJetsInHF_noCleaningCuts' : re.compile(f'(ZJetsToNuNu.*|EW.*|Top_FXFX.*|Diboson.*|.*DYJetsToLL_M-50_HT_MLM.*|.*WJetsToLNu.*HT.*).*{year}'),
                'sr_vbf_noHFHFveto' : re.compile(f'(ZJetsToNuNu.*|EW.*|Top_FXFX.*|Diboson.*|.*DYJetsToLL_M-50_HT_MLM.*|.*WJetsToLNu.*HT.*).*{year}'),
                'sr_vbf_noCleaningCuts' : re.compile(f'(ZJetsToNuNu.*|EW.*|Top_FXFX.*|Diboson.*|.*DYJetsToLL_M-50_HT_MLM.*|.*WJetsToLNu.*HT.*).*{year}'),
