...
def plot(args):
        ...
        for year in [2017,2018]:
            ...
            data = {
                'sr_vbf' : f'MET_{year}',
                'sr_vbf_veto_noisy_jets' : f'MET_{year}',
            ...
            mc_lo = {
                ...
                'sr_vbf_veto_noisy_jets' : re.compile(f'(ZJetsToNuNu.*|EW.*|Top_FXFX.*|Diboson.*|QCD_HT.*|.*DYJetsToLL_M-50_HT_MLM.*|.*WJetsToLNu.*HT.*).*{year}'),
