...
def datasets(year, unblind=False):
    ...
    mc = {
            'sr_vbf_no_veto_all' : re.compile(f'(WH_WToQQ_Hinv_M125.*|(VBF|GluGlu)_HToInvisible.*M125(_HiggspTgt190)?_pow.*|ggZH.*|ZJetsToNuNu.*|EW.*|Top_FXFX.*|Diboson.*|QCD_HT.*|DYJetsToLL.*|WJetsToLNu.*HT.*).*{year}'),
